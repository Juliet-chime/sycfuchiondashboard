...
const Cart = () => {
  ...
  return (
    ...
    <div className="flex justify-between items-center">
          ...
          <button className={`text-2xl hover:bg-light-gray p-3 hover:drop-shadow-xl rounded-full`} style={{background:currentColor, color:"rgb(153, 171, 180)"}} onClick={()=>handleClick('cart',false)}><MdOutlineCancel /></button>
        </div>
