...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <div className='flex'>
      <NavButton title='Cart' customFunc={()=>handleClick('cart',true)}
      color={currentColor}
      icon={<FiShoppingCart/>}
      />
       <NavButton title='Chat' customFunc={()=>handleClick('chat',true)}
      color={currentColor}
      dotColor='#03c9d7'
      icon={<BsChatLeft/>}/>

<NavButton title='Notification' customFunc={()=>handleClick('notification',true)}
      color={currentColor}
      dotColor='#03c9d7'
